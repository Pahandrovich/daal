...
string datasetFileNames[nBlocks] = { 
    "/nfs/inn/proj/numerics1/Users/pyakovle/scikit-learn-enabling/conformance/daal09-dbscan/household_power_consumption_sub_feature_2_aa",
    "/nfs/inn/proj/numerics1/Users/pyakovle/scikit-learn-enabling/conformance/daal09-dbscan/household_power_consumption_sub_feature_2_ab"
    };
...
void geometricPartitioning()
{
    ...
    while (true)
    {
        ...
        if (partitionedData->size() == 0)
            partitionedData->push_back(NumericTable::cast((*curPartitionedData)[rankId]));
