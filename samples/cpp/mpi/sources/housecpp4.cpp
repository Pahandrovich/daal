...
string datasetFileNames[nBlocks] = { 
    "/nfs/inn/proj/numerics1/Users/pyakovle/scikit-learn-enabling/conformance/daal09-dbscan/household_power_consumption_sub_feature_4_aa",
    "/nfs/inn/proj/numerics1/Users/pyakovle/scikit-learn-enabling/conformance/daal09-dbscan/household_power_consumption_sub_feature_4_ab",
    "/nfs/inn/proj/numerics1/Users/pyakovle/scikit-learn-enabling/conformance/daal09-dbscan/household_power_consumption_sub_feature_4_ac",
    "/nfs/inn/proj/numerics1/Users/pyakovle/scikit-learn-enabling/conformance/daal09-dbscan/household_power_consumption_sub_feature_4_ad"
    };
...
const size_t minObservations = 100;
...
int main(int argc, char * argv[])
{
    ...
    //if (argc == 3)
    //{
    //    datasetFileNames[0] = string(argv[1]);
    //    datasetFileNames[1] = string(argv[2]);
    //}
    ...
    printf("RANK %d: ------------------------------ start geometricPartitioning()----------------------------\n", rankId);
    geometricPartitioning();

    printf("RANK %d: ------------------------------ start clustering() --------------------------------------\n", rankId);
    clustering();
...
void geometricPartitioning()
{
    ...
    printf("RANK %d: step1 start\n", rankId);
    step1.compute();
    printf("RANK %d: step1 completed\n", rankId);
    ...
    while (true)
    {
        ...
        printf("RANK %d: step2 start\n", rankId);
        step2.compute();
        printf("RANK %d: step2 completed\n", rankId);
        ...
        //printf("RANK %d: partialBoundingBoxes1->size = %zu\n", rankId, partialBoundingBoxes->size());
        ...
        printf("RANK %d: step3 start\n", rankId);
        step3.compute();
        printf("RANK %d: step3 completed\n", rankId);
        ...
        printf("RANK %d: step4 start\n", rankId);
        step4.compute();
        printf("RANK %d: step4 completed\n", rankId);
        ...
        printf("RANK %d: curPartitionedData->size = %zu\n", rankId, curPartitionedData->size());
        printf("RANK %d: nRows 0  = %zu\n", rankId, NumericTable::cast((*curPartitionedData)[0])->getNumberOfRows());
        printf("RANK %d: nRows 1  = %zu\n", rankId, NumericTable::cast((*curPartitionedData)[1])->getNumberOfRows());
        ...
        printf("RANK %d: partitionedData2->size = %zu\n", rankId, partitionedData->size());
        printf("RANK %d: partitionedPartialOrders2->size = %zu\n", rankId, partitionedPartialOrders->size());
...
void clustering()
{
    ...
    printf("RANK %d: partitionedData3->size = %zu\n", rankId, partitionedData->size());
    //printf("RANK %d: partialBoundingBoxes3->size = %zu\n", rankId, partialBoundingBoxes->size());
    //printf("step5: NumericTable::cast((*partialBoundingBoxes)[0])->getNumberOfRows() = %zu\n", NumericTable::cast((*partialBoundingBoxes)[0])->getNumberOfRows());
    //printf("step5: NumericTable::cast((*partialBoundingBoxes)[0])->getNumberOfColumns() = %zu\n", NumericTable::cast((*partialBoundingBoxes)[0])->getNumberOfColumns());
    //printf("step5: NumericTable::cast((*partialBoundingBoxes)[1])->getNumberOfColumns() = %zu\n", NumericTable::cast((*partialBoundingBoxes)[1])->getNumberOfColumns());
    ...
    printf("RANK %d: step2 completed\n", rankId);
    NumericTablePtr curBoundingBox = step2.getPartialResult()->get(dbscan::boundingBox);
    //printf("RANK %d: curBoundingBox->getNumberOfRows = %zu\n", rankId, curBoundingBox->getNumberOfColumns());

    sendTableAllToAll(0, comm_size, rankId, step2ResultBoundingBoxTag, curBoundingBox, partialBoundingBoxes, true /* preserveOrder */);

    printf("RANK %d: partitionedData2->size = %zu\n", rankId, partitionedData->size());
    printf("RANK %d: partialBoundingBoxes2->size = %zu\n", rankId, partialBoundingBoxes->size());

    //printf("RANK %d: partialBoundingBoxes2 nRows 0  = %zu\n", rankId, NumericTable::cast((*partialBoundingBoxes)[0])->getNumberOfRows());
    //printf("RANK %d: partialBoundingBoxes2 nRows 1  = %zu\n", rankId, NumericTable::cast((*partialBoundingBoxes)[1])->getNumberOfRows());
    ...
    printf("RANK %d: step5 start\n", rankId);
    step5.compute();
    printf("RANK %d: step5 completed\n", rankId);
    ...
    printf("RANK %d: step6 start\n", rankId);
    step6.compute();
    printf("RANK %d: step6 completed\n", rankId);
    ...
    while (computeFinishedFlag() == 0)
    {
        ...
        printf("RANK %d: step8 start\n", rankId);
        step8.compute();
        printf("RANK %d: step8 completed\n", rankId);
    ...
    if (rankId == 0)
    {
        ...
        printf("RANK %d: step9 start\n", rankId);
        step9.compute();
        printf("RANK %d: ...\n", rankId);
        step9.finalizeCompute();
        printf("RANK %d: step9 completed\n", rankId);
    ...
    printf("RANK %d: step10 start\n", rankId);
    step10.compute();
    printf("RANK %d: step10 completed\n", rankId);
    ...
    while (computeFinishedFlag() == 0)
    {
        ...
        printf("RANK %d: step11 start\n", rankId);
        step11.compute();
        printf("RANK %d: step11 completed\n", rankId);
    ...
    printf("RANK %d: step12 start\n", rankId);
    step12.compute();
    printf("RANK %d: step12 completed\n", rankId);
    ...
    printf("RANK %d: step13 start\n", rankId);
    step13.compute();
    printf("RANK %d: ...\n", rankId);
    step13.finalizeCompute();
    printf("RANK %d: step13 completed\n", rankId);
...
int computeFinishedFlag()
{
    if (rankId == 0)
    {
        ...
        printf("RANK %d: step7 start\n", rankId);
        step7.compute();
        printf("RANK %d: step7 completed\n", rankId);
                       ...
                       bool preserveOrder)
{
    ...
    for (size_t shift = 0; shift < nShifts; shift++)
    {
        ...
        if (partnerTable.get() && partnerTable->getNumberOfRows() > 0)
        {
            printf("RANK %d:    partnerTable->getNumberOfRows() = %zu\n",curId, partnerTable->getNumberOfRows());    
            if (preserveOrder)
            {
